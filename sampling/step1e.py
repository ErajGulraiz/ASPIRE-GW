...
xran= ((alpha+1)*ran/nc +mmin**(alpha+1))**(1./(alpha+1)) #exact form of power law prob dist, normalizing the area under the curve to make it a probability density function.
#plt.hist(xran)
#plt.show()
